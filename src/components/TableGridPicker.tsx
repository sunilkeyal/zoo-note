...
// Standalone size grid, reusable inside any container (e.g. an "Insert" menu).
export function TableSizeGrid({ editor, onInsert }: { editor: Editor; onInsert?: () => void }) {
    ...
    <TooltipProvider>
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent className="w-auto p-3" align="start">
          <TableSizeGrid editor={editor} onInsert={() => setOpen(false)} />
        </PopoverContent>
      </Popover>
    </TooltipProvider>
  )
